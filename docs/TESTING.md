...
Responsive manual/browser qualification targets widths 1280, 430, 375, and 320 for login, Month, Day, Admin, builder, and preview. It includes changing branding through Admin, rendering a realistically longer name, and permanent overflow diagnostics. Confirm no horizontal overflow; calendar/list switching and swipe navigation; keyboard selection; note visibility; public-holiday focus labels; and draft invisibility.
