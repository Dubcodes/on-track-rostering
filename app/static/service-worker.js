...
const SHELL_PATHS = ["/static/style.css", "/static/redeputy.css", "/static/branding.css", "/static/track-palette.css", "/static/app.js", "/static/invite.js", "/static/passkeys.js", "/static/notifications.js"];
...
async function offlineRosterPage() {
  ...
  return new Response(`<!doctype html><meta name="viewport" content="width=device-width"><title>${productName} offline</title><link rel="stylesheet" href="${assetUrl("/static/style.css")}"><link rel="stylesheet" href="${assetUrl("/static/redeputy.css")}"><link rel="stylesheet" href="${assetUrl("/static/branding.css")}"><link rel="stylesheet" href="${assetUrl("/static/track-palette.css")}"><main class="page-shell"><h1>Upcoming work</h1><div class="offline-banner">Offline — showing roster saved at ${saved}</div><section class="panel"><ul>${rows || "<li>No upcoming work was saved.</li>"}</ul></section><p>Reconnect to view or edit the authoritative roster.</p></main>`, {headers: {"Content-Type": "text/html; charset=utf-8"}});
}
